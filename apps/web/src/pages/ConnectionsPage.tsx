...
const INSTAGRAM_CFG: CardConfig = {
  ...
  label: 'Instagram',
  experimental: true,
  credLabel: 'Instagram cookie',
  credPlaceholder: 'Paste your instagram.com cookie header value…',
  userLabel: 'Instagram username',
  userPlaceholder: 'your_handle',
  save: saveInstagramCredential,
  disconnect: disconnectInstagram,
  helpTitle: 'How do I get my Instagram cookie?',
  helpSteps: [
    <>Open <span className="text-foreground">instagram.com</span> in your browser, logged in.</>,
    <>Open DevTools (<span className="text-foreground">F12</span> → <span className="text-foreground">Network</span>).</>,
    <>Reload, click the first request to <span className="text-foreground">instagram.com</span>.</>,
    <>Under <span className="text-foreground">Request Headers</span>, copy the entire <span className="text-foreground">cookie:</span> value (it must include <span className="text-foreground">sessionid</span> and <span className="text-foreground">csrftoken</span>).</>,
